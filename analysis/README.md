...
1. **Ratings** - every round, an agent is asked to rate each of its goods 1 to 10 based on how much they want it. These are averaged out every run, binned by condition.
...
6. **Reasoning Valuation** - when asked "how important is another unit of each good to you right now", uses a sentence transformer to try and extract the numeric valuation
